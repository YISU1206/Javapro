...
//////////////////////////////////////////////////////////////////////////////
    ...
    public static int wordPuzzle1(char[][] tar,MyHashTable LHT,int ROW, int COL){
...
//////////////////////////////////////////////////////////////////////////////
    ...
    public static int wordPuzzle2(char[][] tar,MyHashTable LHT,int ROW, int COL){
...
//////////////////////////////////////////////////////////////////////////////
    ...
    public static void main(String[] args) {
	 ...
	 try (BufferedReader br = new BufferedReader(new FileReader(FILENAME))) {
		 ...
		 String words;
         int j =0;
         MyHashTable LHT=new MyHashTable();
				...
				StringBuilder word = new StringBuilder();
   				...
   				for (int i=0;i<words.length();i++) {
   					...
   					if (word.length()<words.length()) 
   					    LHT.put(j, word.toString(), 0);   
   					else 
   						LHT.put(j,  word.toString(), 1);
   				    j++;
